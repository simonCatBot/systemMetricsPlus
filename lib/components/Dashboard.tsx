...
function ColumnHeader({
  ...
  return (
    ...
    >
      ...
      <h3 className={`text-[10px] font-semibold ${isActive ? "text-foreground" : "text-muted-foreground"}`}>
        {title}
      </h3>
    </button>
  );
      ...
      <div className="mb-3">
        <div className="flex items-center justify-between mb-1">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[10px] font-medium text-foreground">CPU Usage</span>
          </div>
          <div className="flex items-center gap-3">
            ...
            <span className={`text-[10px] font-bold ${usage > 80 ? "text-red-500" : "text-foreground"}`}>
              {Math.round(usage)}%
            </span>
          </div>
        </div>
    ...
    <Column isActive={isActive} onClick={onClick}>
        ...
        <div className="flex items-start justify-between mb-2">
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] font-semibold text-foreground truncate">{primaryGpu.marketingName || primaryGpu.name}</p>
            </div>
          </div>
          {trainingStatus && (
            <div className={`flex items-center gap-1.5 px-2.5 py-1 rounded-full ${trainingStatus.bg} border border-border/50`}>
              ...
              <span className={`text-[10px] font-medium ${trainingStatus.color}`}>{trainingStatus.label}</span>
            </div>
          )}
        </div>
      ...
      <div className="mb-3">
        <div className="flex items-center justify-between mb-1">
          <div className="flex items-center gap-1.5">
            <Gauge className="w-4 h-4 text-primary" />
            <span className="text-[10px] font-medium text-foreground">GPU Usage</span>
          </div>
          <div className="flex items-center gap-3">
            <div className="w-32 h-2 bg-surface-2 rounded-full overflow-hidden">
              <div
            ...
            <span className={`text-[10px] font-bold ${(primaryGpu.usage ?? 0) > 80 ? "text-red-500" : "text-foreground"}`}>
              {primaryGpu.usage ?? 0}%
            </span>
          </div>
        </div>
      ...
      <div className="mb-3">
        <div className="flex items-center justify-between mb-1">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[10px] font-medium text-foreground">VRAM</span>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className={`text-[10px] font-bold ${vramStatus.color}`}>
              {vramStatus.percent}%
            </span>
          </div>
        </div>
      ...
      {rocmDetected && (
        <div className="flex items-center gap-2 pt-2 mt-3 border-t border-border/30">
          ...
          />
          <span className="text-[10px] text-muted-foreground">Powered by ROCm {rocmRuntimeVersion}</span>
        </div>
      )}
...
function NetworkColumn({
  ...
  return (
    <Column isActive={isActive} onClick={onClick}>
      ...
      {/* Interface Info */}
      <div className="mb-3">
        <p className="text-[10px] font-medium text-foreground">{primaryInterface.name}</p>
      </div>
...
function DiskColumn({
  ...
  return (
    <Column isActive={isActive} onClick={onClick}>
      ...
      <div className="mb-3">
        <div className="flex items-center justify-between mb-1">
          <span className="text-[10px] text-muted-foreground">Total Usage</span>
          <span className={`text-[10px] font-bold ${totalUsage > 80 ? "text-red-500" : "text-foreground"}`}>
            {totalUsage}%
          </span>
        </div>
        <div className="h-2 bg-surface-2 rounded-full overflow-hidden">
        ...
        {disks.map((disk) => (
          <div key={disk.name} className="p-2 bg-surface-2 rounded">
            <div className="flex justify-between items-center mb-1">
              <span className="text-[10px] text-foreground truncate">{disk.name.split("/").pop()}</span>
              <span className="text-[10px] text-muted-foreground">{disk.usage}%</span>
            </div>
